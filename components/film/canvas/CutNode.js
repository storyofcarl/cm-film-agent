      ...
      <div style={{ padding: 10, display: 'flex', flexDirection: 'column', gap: 6 }}>
        ...
        <div>
          ...
          <div style={{ display: 'flex', gap: 6, flexWrap: 'wrap', alignItems: 'center' }}>
            ...
            <Checkbox className="nodrag" disabled={videoTraits(videoModel).nativeAudio} checked={videoTraits(videoModel).nativeAudio || data.generateAudio !== false} onChange={(c) => patch({ generateAudio: c })}><Text style={{ fontSize: 10, color: '#9fb4d0' }}>{videoTraits(videoModel).nativeAudio ? 'native audio' : 'audio'}</Text></Checkbox>
