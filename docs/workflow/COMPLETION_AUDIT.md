...
| Long-film chat and retained production history | WD38 audit confirms full-context assembly, a 650,000-character chat guard and a 12 MB project-store cap. Oversized requests preserve data; selecting a scene does not reduce context | Engineering incomplete: retrieval/whole-deliverable partitioning and scalable history storage, followed by long-film validation |
